...
use App\Models\FinishedStatusNMDTO;

class FinishedStatusNMController extends Controller
{
    ...
    public function index()
    {
        ...
        $ticketsGrouped = FinishedStatusNMDTO::getTicketsGroupedByStatus();
        ...
        return $this->renderizarView('tickets-analysts-nm', [
            'chartData' => $chartData
        ]);
    }
}
