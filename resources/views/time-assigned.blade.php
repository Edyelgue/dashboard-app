...
<section class="text-gray-600 body-font pt-[90px]">
  <div class="container mx-auto flex flex-wrap justify-between items-start">
    ...
    <!-- Gráfico -->
    <div class="2xl:w-3/4 w-2/3 border shadow-lg rounded-lg px-6 py-4 flex flex-col items-center bg-white" data-theme="light">
            ...
            <tr>
              <th>
                <div class="relative flex items-center border rounded-md">
                  ...
                  <button class="absolute right-2 bg-transparent p-1 text-gray-500 hover:text-gray-700 sort-btn"
