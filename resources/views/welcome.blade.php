      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
            ...
            <p class="text-gray-400"><a href="/tickets-analysts">Relação de Tickets Fechados e Cancelados por Analista -
                N1</a></p>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
            ...
            <p class="text-gray-400"><a href="/tickets-analysts-nm">Relação de Tickets Fechados e Cancelados por
                Analista - Monitoramento</a></p>
          </div>
        </div>
      </div>
      <!-- <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
