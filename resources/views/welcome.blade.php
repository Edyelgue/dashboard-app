    ...
    <div class="flex flex-wrap -m-2">
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <p>&nbsp;&nbsp;&nbsp;</p>
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium"><a href="/time-assigned">NOC Incidentes</a></h2>
            <p class="text-gray-500"><a href="/time-assigned">Tempo Médio de Ticket na Fila</a></p>
          </div>
        </div>
      </div>
      <!-- <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
