      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
            ...
            <p class="text-gray-400"><a href="/time-assigned">Tempo Médio de Ticket na Fila</a></p>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-500 title-font font-semibold"><a href="/tickets-assigned">NOC Monitoramento</a></h2>
            <p class="text-gray-400"><a href="/tickets-assigned">Relação de Tickets Fechados e Cancelados por analista</a></p>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
